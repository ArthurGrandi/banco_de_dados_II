...
BEGIN
    INSERT INTO clientes (idCliente, nome, telefone, logradouro, numero, cidade, bairro, complemento, estado)
    VALUES (v_idCliente, v_nome, v_telefone, v_logradouro, v_numero, v_cidade, v_bairro, v_complemento, v_estado); -- Incluído v_idCliente no INSERT
END;
$$ LANGUAGE plpgsql;
